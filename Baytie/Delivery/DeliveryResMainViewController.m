//
//  DeliveryResMainViewController.m
//  Baytie
//
...
@interface DeliveryResMainViewController ()<DeliveryResCellDelegate>{
...
@implementation DeliveryResMainViewController
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.lblDeliveryTime.text = [NSString stringWithFormat:@"%@ MINS", [dict objectForKey:@"order_time"]];
...
- (void)onReloadTableView{
    [deliveryResTableView reloadData];
}
...
- (IBAction)onFilterPromo:(id)sender {
    ...
    [filteredRestros removeAllObjects];
    for (NSDictionary *dict in allRestros) {
//        if ([dict objectForKey:@"promo_id"] && ![[dict objectForKey:@"promo_id"] isKindOfClass:[NSNull class]]) {
//            if ([[dict objectForKey:@"promo_id"] integerValue] != 0) {
//                [filteredRestros addObject:dict];
//            }
//        }
        if ([dict objectForKey:@"restro_status"]) {
