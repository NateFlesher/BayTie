//
//  SelectedCateringResViewController.m
//  Baytie
//
...
@interface SelectedCateringResViewController (){
...
@implementation SelectedCateringResViewController
        ...
        if ([[_responseObject objectForKey:@"code"] integerValue] == 0) {
            ...
            void ( ^successed )( id _responseObject ) = ^( id _responseObject )
            {
                ...
                if ([[_responseObject objectForKey:@"code"] integerValue] == 0) {
                    ...
                    [cateringFoodMenuTableView reloadData];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    SelectedCateringFoodViewController *viewcontroller = [[SelectedCateringFoodViewController alloc] initWithNibName:@"SelectedCateringFoodViewController" bundle:nil];
...
- (IBAction)onCateringResInfo:(id)sender {
    CateringSelectedResInfoViewController *viewcontroller = [[CateringSelectedResInfoViewController alloc] initWithNibName:@"CateringSelectedResInfoViewController" bundle:nil];
